...
class Page{
    ...
    public function show($iscount = true) {
        ...
        if($this->totalPages > $this->rollPage && ($this->nowPage - $now_cool_page) >= 1){
            $the_first = '';
            /*$the_first = '<a class="first" href="' . $this->url(1) . '"><li>' . $this->config['first'] . '</li></a>';*/
        }
        ...
        if($this->totalPages > $this->rollPage && ($this->nowPage + $now_cool_page) < $this->totalPages){
            $the_end = '';
            /*$the_end = '<a class="end" href="' . $this->url($this->totalPages) . '"><li>' . $this->config['last'] . '</li></a>';*/
        }
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page <= $this->totalPages){
                    if( $i==$this->rollPage ){
                        ...
                        $this->url = U(ACTION_NAME, $this->parameter);
                        $link_page .= '<a class="num" href="' . $this->url($page) . '"><li>...</li></a>'; 
                    }else{
                        $this->parameter[$this->p] = $page;
                        $this->url = U(ACTION_NAME, $this->parameter);
                        $link_page .= '<a class="num" href="' . $this->url($page) . '"><li>' . $page . '</li></a>'; 
                    }
                ...
                if($page > 0 && $this->totalPages != 1){
                    $link_page .= '<li style="background-color:gray;color:white;border:none;">' . $page . '</li>';
                }
            }
        }
